...
function theme_boost_app_bus_get_main_scss_content($theme) {
    ...
    if ($filename == 'default.scss') {
        ...
        $scss .= file_get_contents($CFG->dirroot . '/theme/boost_app_bus/scss/preset/unitec_std.scss');
    } else if ($filename == 'var_00.scss') {
        $scss .= file_get_contents($CFG->dirroot . '/theme/boost_app_bus/scss/preset/var_00.scss');
    } else if ($filename == 'var_01.scss') {
        $scss .= file_get_contents($CFG->dirroot . '/theme/boost_app_bus/scss/preset/var_01.scss');
    } else if ($filename == 'var_02.scss') {
        $scss .= file_get_contents($CFG->dirroot . '/theme/boost_app_bus/scss/preset/var_02.scss');
    } else if ($filename == 'var_03.scss') {
        $scss .= file_get_contents($CFG->dirroot . '/theme/boost_app_bus/scss/preset/var_03.scss');
